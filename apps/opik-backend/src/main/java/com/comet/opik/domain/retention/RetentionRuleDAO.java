...
interface RetentionRuleDAO {
    ...
    @SqlUpdate("INSERT INTO retention_rules" +
            " (id, workspace_id, project_id, retention, filter, apply_to_past, enabled, created_by, last_updated_by)" +
            " VALUES" +
            " (:rule.id, :workspaceId, :rule.projectId, :rule.retention, :rule.filter, :rule.applyToPast, :rule.enabled, :rule.createdBy, :rule.lastUpdatedBy)")
