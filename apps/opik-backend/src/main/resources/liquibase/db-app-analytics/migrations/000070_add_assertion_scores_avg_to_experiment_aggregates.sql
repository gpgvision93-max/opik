...
--changeset danield:000070_add_assertion_scores_avg_to_experiment_aggregates
--comment: Add assertion_scores_avg field to experiment_aggregates table for per-assertion pass rate tracking in evaluation suite experiments
