...
export const PAGE_SHORT_LABELS: Record<PAGE_ID, string> = {
  [PAGE_ID.home]: "Home",
  [PAGE_ID.dashboards]: "Dashboards",
  [PAGE_ID.dashboard_detail]: "Dashboard",
  [PAGE_ID.projects]: "Projects",
  [PAGE_ID.project_traces_table]: "Traces table",
  [PAGE_ID.project_spans_table]: "Spans table",
  [PAGE_ID.project_threads_table]: "Threads table",
  [PAGE_ID.project_metrics]: "Project metrics",
  [PAGE_ID.project_online_evaluation]: "Online evaluation",
  [PAGE_ID.project_annotation_queues]: "Annotation queues",
  [PAGE_ID.project_dashboard]: "Project dashboard",
  [PAGE_ID.experiments]: "Experiments",
  [PAGE_ID.compare_experiments]: "Compare experiments",
  [PAGE_ID.optimizations]: "Optimizations",
  [PAGE_ID.optimization_new]: "New optimization",
  [PAGE_ID.optimization_detail]: "Optimization detail",
  [PAGE_ID.compare_optimizations]: "Compare optimizations",
  [PAGE_ID.compare_trials]: "Compare trials",
  [PAGE_ID.datasets]: "Datasets",
  [PAGE_ID.dataset_detail]: "Dataset detail",
  [PAGE_ID.dataset_items]: "Dataset items",
  [PAGE_ID.prompts]: "Prompts",
  [PAGE_ID.prompt_detail]: "Prompt detail",
  [PAGE_ID.playground]: "Playground",
  [PAGE_ID.configuration]: "Configuration",
  [PAGE_ID.alerts]: "Alerts",
  [PAGE_ID.alert_edit]: "Alert editor",
  [PAGE_ID.online_evaluation]: "Online evaluation",
  [PAGE_ID.annotation_queues]: "Annotation queues",
  [PAGE_ID.annotation_queue_detail]: "Annotation queue",
  [PAGE_ID.automation_logs]: "Automation logs",
  [PAGE_ID.get_started]: "Get started",
  [PAGE_ID.unknown]: "Unknown page",
};
