...
<CardGroup cols={2}>
    ...
    <Card title="OpenAPI spec" icon="fa-regular fa-file-code" href="https://raw.githubusercontent.com/comet-ml/opik/refs/heads/main/apps/opik-documentation/documentation/fern/openapi/opik.yaml">
    Machine-readable OpenAPI source for the REST API reference
    </Card>
